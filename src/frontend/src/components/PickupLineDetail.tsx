import { X, MessageCircleHeart, Instagram, Flag, Lightbulb, Copy, Check } from 'lucide-react';
...
export function PickupLineDetail({ pickupLine, isOpen, onClose }: PickupLineDetailProps) {
