...
export function AppLayout({ children, currentView, onViewChange, onRandomClick, hasPickupLines }: AppLayoutProps) {
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'url(/assets/generated/doodle-pattern.dim_2048x2048.png)',
